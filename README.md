...
⚠️ **_Be extra careful NOT to commit those changes, as they might leak potentially sensitive information!_** <br>
...
- `appTitle` (string): Set the name of the application in the header area.<br>**Default**: EDC Dashboard
...
- `healthCheckIntervalSeconds` (number): Sets the interval in seconds to check if the connection to the current connector is still established.<br>**Default**: `30`
